...
class ClienteCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		*/
        ...
        $this->crud->setColumns(['nombre', 'rfc', 'calle', 'noExterior', 'colonia', 'municipio', 'estado', 'pais', 'codigoPostal']);

        $this->crud->addColumn([
            'label' => 'Cliente Promotor',
            'type' => 'select',
            'name' => 'cliente_promotor_id',
            'entity' => 'cliente_promotor',
            'attribute' => 'nombre',
            'model' => "App\Models\ClientePromotor",
        ]);

        $this->crud->addField([
            'label' => "Cliente Promotor",
            'type' => 'select',
            'name' => 'cliente_promotor_id', // the db column for the foreign key
            'entity' => 'cliente_promotor', // the method that defines the relationship in your Model
